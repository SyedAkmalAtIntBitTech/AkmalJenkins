 ...
 * @author intbit
 */
public class GetUserPreferences extends HttpServlet {
...
//        Integer user_id = 40;
        try {
                ...
                prepared_statement = sql_methods.con.prepareStatement(query_string);
...
//                    brand_id = rs2.getInt(1);
                    Statement stmt3 = sql_methods.con.createStatement();
                    ...
                    if (rs3.next()){
                            ...
                            Statement stmt4 = sql_methods.con.createStatement();
                            ...
                            Statement stmt5 = sql_methods.con.createStatement();
                            ...
                            Statement stmt6 = sql_methods.con.createStatement();
                            ...
                            Statement stmt7 = sql_methods.con.createStatement();
                            ...
                            Statement stmt8 = sql_methods.con.createStatement();
        ...
        /*-------------------------------script to get the font sizes from the database ----------------------------*/
                            ...
                            Statement stmt9 = sql_methods.con.createStatement();
                            ...
                            Statement stmt10 = sql_methods.con.createStatement();
                            ...
                            Statement stmt11 = sql_methods.con.createStatement();
                            ...
                            Statement stmt12 = sql_methods.con.createStatement();
                            ...
                            Statement stmt13 = sql_methods.con.createStatement();
