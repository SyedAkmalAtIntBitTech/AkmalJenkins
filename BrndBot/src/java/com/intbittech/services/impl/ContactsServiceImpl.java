...
public class ContactsServiceImpl implements ContactsService {
    ...
    public Integer addContact(ContactDetails contactDetails) {
        ...
        Boolean isEmailUnsubscribed = Boolean.FALSE;
        if (unsubscribedEmails != null) {
            isEmailUnsubscribed = unsubscribedEmailCompanyDao.isEmailUnsubscribed(contactDetails.getCompanyId(), unsubscribedEmails.getUnsubscribedEmailId());
        }
