...
public class PushedScheduledActionEntityList implements Serializable {
    ...
    public PushedScheduledActionEntityList() {
    }

    public PushedScheduledActionEntityList(Integer scheduledEntityListId) {
