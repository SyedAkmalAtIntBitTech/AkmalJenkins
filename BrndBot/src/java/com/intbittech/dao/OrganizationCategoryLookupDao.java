...
/**
 * <code> {@link OrganizationCategoryLookupDao} </code> Interface to get
 * OrganizationCategoryLookup details from Channel table
 *
 * @author Ajit
 */
public interface OrganizationCategoryLookupDao {
