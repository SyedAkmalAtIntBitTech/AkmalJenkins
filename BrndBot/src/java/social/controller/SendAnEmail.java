...
public class SendAnEmail {
    ...
    public String getAllEmailAddressesForEmailList(Integer userId, Integer days) throws Throwable {
        ...
        org.json.simple.JSONArray jSONArray = (org.json.simple.JSONArray) jsonObject.get("emailAddresses");
