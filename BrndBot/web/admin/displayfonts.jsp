...
<%    try {
        ...
        if (user_id.equals("0")) {
            ...
            while (rs2.next()) {
                ...
                Statement stmt3 = SM.getConnection().createStatement();
                ...
                if (rs3.next()) {
                    ...
                    Statement stmt4 = SM.getConnection().createStatement();
                    ...
                    Statement stmt5 = SM.getConnection().createStatement();
                    ...
                    Statement stmt6 = SM.getConnection().createStatement();
                    ...
                    Statement stmt7 = SM.getConnection().createStatement();
                    ...
                    Statement stmt8 = SM.getConnection().createStatement();
                    ...
                    Statement stmt9 = SM.getConnection().createStatement();
                    ...
                    Statement stmt10 = SM.getConnection().createStatement();
                    ...
                    Statement stmt11 = SM.getConnection().createStatement();
                    ...
                    Statement stmt12 = SM.getConnection().createStatement();
                    ...
                    Statement stmt13 = SM.getConnection().createStatement();
