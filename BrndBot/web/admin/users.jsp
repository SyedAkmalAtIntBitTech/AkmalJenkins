...
String org_id=request.getParameter("org_id");  
 ...
 try{
    ...
    ResultSet rs1 = stmt1.executeQuery("Select * from tbl_category where organization_id="+org_id+"");  
     ...
     ResultSet rs2 = stmt2.executeQuery("Select a.brand_id From tbl_user_preferences a, tbl_user_login_details b where a.user_id=b.id and organizationid="+org_id+"");
            ...
            if (rs3.next()){
                    ...
                    ResultSet rs4 = stmt4.executeQuery("Select * From tbl_font_family where id="+font_id1+"");
                        if (rs4.next()){
                            ...
                            buffer3=buffer3+"<option value='"+font_id1+"'>"+font_name1+"</option>";
                        }
                    rs4.close();
                    stmt4.close();
                    ...
                    ResultSet rs5 = stmt5.executeQuery("Select * From tbl_font_family where id="+font_id2+"");
                        if (rs5.next()){
                            ...
                            buffer3=buffer3+"<option value='"+font_id2+"'>"+font_name2+"</option>";
                        }
                    rs4.close();
                    stmt4.close();
                    ...
                    ResultSet rs6 = stmt6.executeQuery("Select * From tbl_font_family where id="+font_id3+"");
                        if (rs6.next()){
                            ...
                            buffer3=buffer3+"<option value='"+font_id3+"'>"+font_name3+"</option>";
                        }
                    rs4.close();
                    stmt4.close();
                    ...
                    ResultSet rs7 = stmt7.executeQuery("Select * From tbl_font_family where id="+font_id4+"");
                        if (rs7.next()){
                            ...
                            buffer3=buffer3+"<option value='"+font_id4+"'>"+font_name4+"</option>";
                        }
                    rs4.close();
                    stmt4.close();
                    ...
                    ResultSet rs8 = stmt8.executeQuery("Select * From tbl_font_family where id="+font_id5+"");
                        if (rs8.next()){
                            ...
                            buffer3=buffer3+"<option value='"+font_id5+"'>"+font_name5+"</option>";
                        }
                    rs4.close();
                    stmt4.close();
