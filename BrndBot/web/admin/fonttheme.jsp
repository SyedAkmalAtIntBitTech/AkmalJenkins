            ...
            <div  style="margin-top: 0px;">
                ...
                <table border="1" style="margin-top: 20px;">
                    ...
                    <tr>
                        ...
                        <td><%= result_set.getString("font_id6")%></td>
                        <td><%= result_set.getString("font_id7")%></td>
                        <td><%= result_set.getString("font_id8")%></td>
                        <td><%= result_set.getString("font_id9")%></td>
                        <td><%= result_set.getString("font_id10")%></td>
                        <td><%= result_set.getString("font_id11")%></td>
                        <td><%= result_set.getString("font_id12")%></td>
                        <td><%= result_set.getString("font_id13")%></td>
                        <td><%= result_set.getString("font_id14")%></td>
                        <td><%= result_set.getString("font_id15")%></td>                        
