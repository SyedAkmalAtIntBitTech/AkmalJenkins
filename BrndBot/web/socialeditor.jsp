...
//                    alert($(this).attr("text-shadow"));
                                                        $(".preview").append("<div><textarea class=textAreas onclick=getTectId() id=" + type + ">" + elementdata + "This is a testThis is a testThis is a testThis is a testThis is a test</textarea>");
