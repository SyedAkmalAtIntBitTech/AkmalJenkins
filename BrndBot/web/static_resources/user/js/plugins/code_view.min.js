...
!function (a) {
    ...
    "use strict";
    a.extend(a.FroalaEditor.DEFAULTS, {codeMirror: !0, codeMirrorOptions: {lineNumbers: !0, tabMode: "indent", indentWithTabs: !0, lineWrapping: !0, mode: "text/html", tabSize: 2}}), a.FroalaEditor.PLUGINS.codeView = function (b) {
        function c() {
        ...
        function f(a, c) {
            ...
            if (k) {
                ...
                e = d.substring(0, e).length - d.substring(0, d.substring(0, e).lastIndexOf("\n") + 1).length, f = d.substring(0, f).length - d.substring(0, d.substring(0, f).lastIndexOf("\n") + 1).length, k.setSize(null, Math.max(c, 150)), k.setValue(d), k.focus(), k.setSelection({line: g, ch: e}, {line: h, ch: f}), k.refresh(), k.clearHistory()
            } else
        ...
        function g() {
            ...
            if (c())
                b.$box.toggleClass("fr-code-view", !1), e(a);
            else {
                b.popups.hideAll();
        ...
        function i() {
            ...
            })), b.events.on("buttons.refresh", d), b.events.on("copy", d, !0), b.events.on("cut", d, !0), b.events.on("paste", d, !0), b.events.on("destroy", h, !0), b.events.on("form.submit", function () {
