...
!function (a) {
    ...
    "use strict";
    a.extend(a.FroalaEditor.DEFAULTS,{fontFamily: FontArray, fontFamilySelection: !1}), a.FroalaEditor.PLUGINS.fontFamily = function (b) {
        function c(a) {
        ...
        return{apply: c, refreshOnShow: d, refresh: e}
    }, a.FroalaEditor.RegisterCommand("fontFamily", {type: "dropdown", displaySelection: function (a) {
            ...
            for (var c in b)
                a += '<li><a class="fr-command" data-cmd="fontFamily" data-param1="' + c + '" style="font-family: ' + b[c] + '" title="' + b[c] + '">' + b[c] + "</a></li>";
            return a += "</ul>"
        ...
        }}), a.FroalaEditor.DefineIcon("fontFamily", {NAME: "font"})
});