  ...
  //**************** assetsFactory **********************//
   ...
   //**************** emailFactory **********************//    
    ...
    this. listDataURL = function () {
        return this.getGlobalURL() + " /externalContent/getListData/{externalSourceKeywordLookupId}";
    };
    ...
    this. signupURL = function () {
        return this.getGlobalURL() + " /signup/{jspFileName}";
    };
    ...
    this. imageIdURL = function () {
        return this.getGlobalURL() + " /images/get/{imageId}";
    };
    ...
    this. deleteCompanyImagesURL = function () {
        return this.getGlobalURL() + " /companyImages/delete/{companyImageId}";
    };
    ...
    this. fbGetTokenURL = function () {
        return this.getGlobalURL() + " /settings/fbGetToken/{code}";
    };
    ...
    this. twitterGetTokenURL = function () {
        return this.getGlobalURL() + " /settings/twitterGetToken/{pin}";
    };
    ...
    this. userJspPagesURL = function () {
        return this.getGlobalURL() + " /user/{jspFileName}";
    };
