...
!function (a) {
    ...
    b.DEFAULTS = {initOnClick: !1}, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.0.4", b.INSTANCES = [], b.ID = 0, b.prototype._init = function () {
        ...
        for (var b in a)
            if (!this[b] && (this[b] = new a[b](this), this[b]._init && (this[b]._init(), this.opts.initOnClick && "core" == b)))
                return!1
        ...
        function d() {
            ...
            if (c() > 0)
                ...
                var b = navigator.userAgent.toLowerCase(), d = /(edge)[ \/]([\w.]+)/.exec(b) || /(chrome)[ \/]([\w.]+)/.exec(b) || /(webkit)[ \/]([\w.]+)/.exec(b) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(b) || /(msie) ([\w.]+)/.exec(b) || b.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(b) || [], e = {browser: d[1] || "", version: d[2] || "0"};
        ...
        function t(c, d, e) {
            if (!b.edit.isDisabled() || e) {
                ...
                if (g)
                    for (var h = 0; h < g.length; h++)
                        f = g[h].apply(b, [d]), "undefined" != typeof f && (d = f);
        ...
        function g() {
            ...
            do {
                ...
                for (var f = 0; f < d.length; f++)
                    (0 === d[f].attributes.length || "undefined" != typeof d[f].getAttribute("href")) && (a(d[f]).remove(), e = !0);
            ...
            if (e && (f = 'div class="fr-temp-div"'), f)
                for (var g = b.node.contents(d.get(0)), h = null, i = 0; i < g.length; i++) {
                    ...
                    if (j.nodeType == Node.ELEMENT_NODE && b.node.isBlock(j))
                        ...
                        if (null == h)
                            e ? a(j).replaceWith("<" + f + ' data-empty="true"><br></div>') : a(j).replaceWith("<" + f + "><br></" + f + ">");
                        else {
                            a(j).remove();
        ...
        function o(c) {
            if ("undefined" == typeof c && (c = b.$el.get(0)), c.nodeType == Node.ELEMENT_NODE && ["STYLE", "SCRIPT", "HEAD"].indexOf(c.tagName) < 0)
                for (var d = b.node.contents(c), e = d.length - 1; e >= 0; e--)
                    a(d[e]).hasClass("fr-marker") || o(d[e]);
            else if (c.nodeType == Node.TEXT_NODE && c.textContent.length > 0) {
                var f = c.previousSibling, g = c.nextSibling;
                if (n(f) && n(g) && 0 === c.textContent.trim().length)
                    a(c).remove();
                else {
                    var h = c.textContent;
        ...
        function d() {
            b.opts.iframe || b.$el.addClass("fr-element fr-view fr-element-custom")
        }
        function e() {
            if (b.$box.addClass("fr-box" + (b.opts.editorClass ? " " + b.opts.editorClass : "")), b.$wp.addClass("fr-wrapper fr-wrapperv2"), d(), b.opts.iframe) {
    ...
    }, a.FroalaEditor.COMMANDS = {bold: {title: "Bold"}, italic: {title: "Italic"}, underline: {title: "Underline"}, strikeThrough: {title: "Strikethrough"}, subscript: {title: "Subscript"}, superscript: {title: "Superscript"}, outdent: {title: "Decrease Indent"}, indent: {title: "Increase Indent"}, undo: {title: "Undo", undo: !1, forcedRefresh: !0}, redo: {title: "Redo", undo: !1, forcedRefresh: !0}, insertHR: {title: "Insert Horizontal Line"}, clearFormatting: {title: "Clear Formatting"}, selectAll: {title: "Select All", undo: !1}}, a.FroalaEditor.RegisterCommand = function (b, c) {
        ...
        function i(c) {
            ...
            if (b.node.isBlock(d)) {
                ...
                if (d.nodeType == Node.TEXT_NODE) {
                    ...
                    b.events.trigger("node.remove", [a(d)]) !== !1 && (a(d).after(a.FroalaEditor.MARKERS), a(d).remove())
            }
        }
        function j() {
        ...
        function l(d) {
            ...
            if (!b.node.isBlock(e) && b.node.isEditable(e)) {
                for (h = b.node.contents(e); e.nodeType != Node.TEXT_NODE && h.length && b.node.isEditable(e); )
        ...
        function d(c, d) {
            if (c.data("title") || c.data("title", c.attr("title")), !c.data("title"))
                return!1;
        ...
        function k() {
            if (!j())
                if (b._stickyElements = [], b.helpers.isIOS()) {
                    ...
                    a("body" == b.opts.scrollableContainer ? b.original_window : b.opts.scrollableContainer).on("scroll.sticky" + b.id, l), a(b.original_window).on("resize.sticky" + b.id, l), b.events.on("initialized", l), b.events.on("focus", l), a(b.original_window).on("resize", "textarea", l)
        }
        function l() {
            for (var a = 0; a < b._stickyElements.length; a++)
        ...
        function m() {
            !q && b.$tb && (b.$tb.find("> .fr-command").addClass("fr-disabled fr-no-refresh"), q = !0)
        }
        function n() {
            q && b.$tb && (b.$tb.find("> .fr-command").removeClass("fr-disabled fr-no-refresh"), q = !1), b.button.bulkRefresh()
        }
        var o, p, q = !1;
        return{_init: l, hide: f, show: g, showInline: e, disable: m, enable: n}
            ...
            return i.append(g), g.data("container", i), t[c] = g, b.button.bindCommands(g, !1), a(b.original_window).on("resize.popups" + b.id, function () {
                ...
                if (a.FroalaEditor.KEYCODE.ENTER == e)
                    ...
                    if (a.FroalaEditor.KEYCODE.ESC == e)
                        return d.preventDefault(), d.stopPropagation(), b.$el.find(".fr-marker") && (b.events.disableBlur(), a(this).data("skip", !0), b.selection.restore(), b.events.enableBlur()), f(c) && g.find(".fr-back:visible").length ? b.button.exec(g.find(".fr-back:visible:first")) : h(c), b.opts.toolbarInline && b.toolbar.showInline(null, !0), !1;
                    d.stopPropagation()
                }
        ...
        var t = {}, u = !1;
        return{_init: s, create: q, get: j, show: d, hide: h, onHide: i, hideAll: m, setContainer: c, refresh: l, onRefresh: k, onShow: e, isVisible: f, areVisible: g}
