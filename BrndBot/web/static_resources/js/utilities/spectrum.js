...
(function (factory) {
    ...
    function spectrum(element, o) {
        ...
        function updateOriginalInput(fireCallback) {
            ...
            $('.palette-colorswab-selected').css("background-color",displayColor);
            $('.palette-colorswab-selected').val(displayColor);
 		...
 		select.change(function(){
			...
			select.find(':selected').each(function(){
				...
				.addClass('color-select-option-selected');
                                $('.palette-colorswab-selected').css("background-color", $(this).attr('value'));
                                $('.palette-colorswab-selected').val($(this).attr('value'));
			});
		});
