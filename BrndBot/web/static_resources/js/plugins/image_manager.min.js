...
!function (a) {
    ...
    "use strict";
    if (a.extend(a.FroalaEditor.DEFAULTS, {imageManagerLoadURL: global_host_address+"getImageList?imageType=GLOBAL_IMAGE&companyId=0", imageManagerLoadMethod: "get", imageManagerLoadParams: {}, imageManagerPreloader: "", imageManagerDeleteURL: "", imageManagerDeleteMethod: "post", imageManagerDeleteParams: {}, imageManagerPageSize: 12, imageManagerScrollOffset: 20, imageManagerToggleTags: !0}), a.FroalaEditor.PLUGINS.imageManager = function (b) {
        function c() {
