            ...
            <div class="pop-up-inner-ep height400">
                <div class="emailPreviews col-1of1 fleft"> 
                    <div class="emailPreview-desktop-col  fleft">
                        ...
                        <div class="iphoneshow img-responsive" id="popup" style="display: block; height: 300px; width: 295px; margin-left: 215px; margin-top: 50px; border-color: transparent; background-image: url(http://development2.brndbot.com/BrndBot/images/imac27.png); background-color: rgb(255, 255, 255); background-size: contain; background-repeat: no-repeat;">
                            <div class="content">  
                    ...
                    <div class="emailPreview-mobile-col fleft">
                        <div class="emailPreview-headers">Desktop Preview</div>
                        <div class="iphoneshow img-responsive" id="" style="display: block; height: 370px; width: 254px; margin-left: 85px; margin-top: 32px; border-color: transparent; background-image: url(http://development2.brndbot.com/BrndBot/images/Phone.svg); background-color: rgb(255, 255, 255); background-size: contain; background-repeat: no-repeat;">
                            <div class="content">  
