                ...
                <div class="row col-md-offset-2" >
                    <div ng-controller="MyController">
                        ...
                        <div class="col-md-12 step_wrapper">
                            <div  class="col-md-2 step_box" ng-repeat="first in First" style="top: 10px;border:1px solid #dadada; border-radius: 5px; margin-left: 26px; margin-bottom: 26px;">
                            ...
                            <div class="col-md-2 step_box" ng-repeat="second in Second" style="border:1px solid #dadada; border-radius: 5px; margin-left: 26px; margin-bottom: 26px;">
