    ...
    <body class="body-normal" ng-app ng-controller="emailBlocksController">        
        ...
        <div class="content-area_header">
            ...
            <div class="header_path fleft" id="createTitle"> Create New Email Template</div>
             <div id="deleteTemplate" class="CTA_Button Button--Delete fright" ng-click="deleteEmailBlocks(<%=emailBlockModelId%>)" >Delete Template</div>
        </div>
        ...
        <div id="uploadOnEdit">
            ...
            <label class="fileContainer">
                ...
                <input name="fileName" type="file" id="imageFileName" value="{{getEmailModels.imageFileName}}"/>
            </label>
        </div>
            ...
            <a  id="saveTemplate" href="#"><div class="CTA_Button Button--Blue fleft pushUp_10 saveEdit" ng-click="updateEmailBlockModel()">Save</div></a>
             <a  ng-click="addEmailBlock()" id="createNewTemplate" href="#"><div class="CTA_Button Button--Blue fleft pushUp_10 createTemplate" >Create New Template</div></a>
              </div>
