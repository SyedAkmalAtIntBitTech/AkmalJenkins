                ...
                <div class="page-subnav-bar-with-dropdown">
                    ...
                    <div class="top-subnav-tabs-container">
                        <ul class="top-subnav-nav-elements">
                            ...
                            <li class="top-subnav-links" id="footertab"> <a class="h3">Footer Settings</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="page-inner-content-container ">
                        <div class="fleft content">
                            <div class="page-content-title-bar">
                                <div class="page-content-title pushUp h2" ng-show="emailLists.length > 0 || emailListsMindbody.length > 0">Your Email Lists </div>
                                <div class="page-content-title pushUp h2" ng-show="emailLists.length == 0 && emailListsMindbody.length == 0">No email lists present</div>
                            </div>
                            <!--List Starts Here-->
                                ...
                                <ul class="main-container fleft">
                                    <li class="slat-container fleft selfclear" ng-show="emailLists.length > 0" ng-repeat="email in emailLists">
                                        ...
                                        <div class="col-7of10 slat-unit fleft ">
                                            <div class="slat-title-container col-1of2 fleft">
                                                <a href="emaillistsdetails?list_name={{email.emailListName}}&type=user">
                                    ...
                                    <li class="slat-container fleft selfclear" ng-repeat="email in emailListsMindbody">
                                        <div class="selection-container col-5p hint--left emailconnectalign" data-hint="EmailConnect">
                                            <img src="images/emailConnect.svg" class="emailConnect-icon" style="cursor:pointer;"> </img>
                                        </div>
                                        <div class="col-7of10 slat-unit fleft ">
                                            <div class="slat-title-container col-1of2 fleft">
                                                <a href="emaillistsdetails?list_name={{email.emailListName}}&type=mindbody">
                                                    <div class="slat-title email-list-slat-title col-1of1 ">{{email.emailListName}}</div>
                                        ...
                                        <div class="col-1of4 fleft">
                                            <div class="slat-cta-container">
                                                <a>
                                                    ...
                                                    <span class="small-button slat-button detail-button-font" ng-click="showdraftpopup(drafts.id, drafts.categoryid, drafts.emailsubject, drafts.editdate, drafts.subcategoryid, drafts.mindbodyid, drafts.lookupid)">View and Edit Draft</span>
                                                </a>
                                            </div>
                                        </div>
                                    </li>
                ...
                <div class="page-content-container email-list-contact-page email-draft-page" id="emailhistorydiv" ng-controller="emailHistory">
                    ...
                    <div class="fleft content"  ng-init="displayemailhistory()">
                        ...
                        <ul class="main-container fleft" id="historydiv" ng-show="email_history.length > 0" >
                            ...
                            <div  ng-repeat="email in email_history">
                                <li class="slat-container fleft selfclear" id="li{{drafts.id}}">
                                    <div class="col-4of10 slat-unit fleft" id="deleteids"> 
                                        <div class="slat-title-container col-1of1 fleft">
                                    ...
                                    <div class="col-2of10 slat-unit fleft ">
                                        <div class="slat-title-container col-1of1 fleft">
