            ...
            <div class=" top-navbar-detail" id="emailtopnavdetails">
                ...
                <div  class="top-navbar-inner-bb-detail">
                    ...
                    <div class="top-nav-cta-container">
                        <div class="approve-button-detail md-button" id="emailtemplatesave" ng-show="email_template_status=='Template Saved'" ng-click="Approval(schedule_id, 'approved', master_email)">Approve</div>
