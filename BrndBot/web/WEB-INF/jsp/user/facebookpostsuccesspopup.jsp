           ...
           <div class="popUp_header clear">
            ...
            <div class="pane_content pane-padding">
                ...
                <div class="postSent-button-wrap">
                    <div class="fleft">
                         <a href="/Social_Sequence/Facebook/SocialSequence-Facebook.html"><div class="CTA_Button Button--Gray ">Post to Facebook</div></a>
                    </div>
                    <div class="fright">
                        <a href="/Dashboard.html"><div class="CTA_Button Button--Gray ">Go to Dashboard</div></a>
                    </div>
                </div>
            </div>
        </div>
