                            ...
                            <div class="saved-post-preview-detail"  id="twtsavedpostdiv">
                                ...
                                <div class="twitter-post-preview">
                                    <div class="Facebook-preview-header">
                                        <div class="Facebook-preview-profpic"><img id="twitter_preview_profpic" src="/BrndBot/downloadImage?imageType=COMPANY_LOGO&companyId=${companyId}&imageName=companylogo.png"/></div>
                                    ...
                                    <div class="Facebook-preview-image">
                                        <div ng-show="entitiesdetails.image_type == 'gallery'">
                                            <img id="prevfbimg" style="max-width: 240px;" src='/BrndBot/downloadImage?imageType=GALLERY&imageName={{entitiesdetails.image_name}}&companyId=${companyId}'/>
                                        </div>
                                        <div ng-show="entitiesdetails.image_type == 'layout'">
                                            <img id="prevfbimg" style="max-width: 240px;" src='/BrndBot/downloadImage?imageType=LAYOUT_IMAGES&imageName={{entitiesdetails.image_name}}'/>
                                        </div>
