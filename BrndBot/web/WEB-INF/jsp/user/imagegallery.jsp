...
<!--                                <div class="galImage-name">Image Name</div>
                                ...
                                <li class="nav-elements-icon-container hint--top"  data-hint="Delete">
                                    <img type="image/svg+xml" id="delete" src="images/trash.svg" class="galCard-trashicon fleft cur" ng-click="deleteImage(images.id, images.user_id, images.image_name)"/>
                                </li>                                 
