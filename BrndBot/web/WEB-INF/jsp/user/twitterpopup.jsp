<%-- 
    Document   : twitterpopup
    Created on : 2 May, 2016, 12:47:30 PM
    Author     : sandeep
--%>

<div class="popUp_background-dark displayNone" id="twitterSetPinPopUp">
    <div class="popUp_CenterVert ">
        ...
        <div class="popUp-bottom-wide" style="width: inherit;">
            <span class="clickable-area">
                <div class="popUp-bottom-link" onclick="setTwitterAccessToken()">Done</div>
            </span>
        </div>
    </div>
</div>
