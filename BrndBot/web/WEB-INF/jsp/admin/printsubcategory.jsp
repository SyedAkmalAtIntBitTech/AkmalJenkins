            ...
            <ul class="slatArea" >
                <li class="listItem" ng-repeat="subcategory in subCategoryDetails">
                    ...
                    <div class="listCol col1of4 fleft">
                        <a href="${pageContext.request.contextPath}/admin/printsubcategorydetails?organizationId={{organizationDetails.organizationId}}&categoryId={{categoryDetails.categoryId}}&subCategoryId={{subcategory.subCategoryId}}"><div class="CTA_Button Button--Gray fright">Manage Sub Category</div></a>
                    </div>
                </li>
            </ul>
