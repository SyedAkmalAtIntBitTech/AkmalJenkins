...
<html>
    ...
    <body class="body-normal" ng-app="uploadImage"  ng-controller="emailBlocksController" >        
        ...
        <div class="content-area_header">
            ...
            <a href="${pageContext.request.contextPath}/admin/editemailblockmodels?edit=no"><div class="CTA_Button Button--Blue fright" id="addTemplate" >Add New Template</div></a>
        </div>
