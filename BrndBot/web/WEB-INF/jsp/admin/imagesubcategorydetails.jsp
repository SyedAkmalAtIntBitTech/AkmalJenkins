<%-- 
    Document   : imagesubcategorydetails
...
<body class="body-normal" ng-app  ng-controller="organizationcontroller">
    ...
    <div class="content-area" ng-init="getAllCategoryDetails()">
        <div class="content-area_header" ng-init="getAllSubCategories()">
            ...
            <div class="header_path fleft"> <a style="text-decoration:none;color:#3E4551;" href="${pageContext.request.contextPath}/admin/imagesubcategory?organizationId=<%=organizationID%>&categoryId=<%=categoryID%>">{{categoryDetails.categoryName}}</a>  > </div>
            <div class="header_title fleft">{{subCategoryDetailsTitle.subCategoryName}}</div>
            <div class="CTA_Button Button--Blue fright" id="addTemplateButton" ng-click="getAllNonAddedImageModelsBySubCategoryId(<%=subCategoryID%>)">Add Template</div>
            <div class="CTA_Button Button--Delete fright" ng-click="deleteSubCategory(<%=subCategoryID%>)">Delete Sub Category</div>
        </div>
        <div class="slatSection" ng-init="getImageModelBySubCategoryId()">
            ...
            <ul class="slatArea">
                <li class="listItem" ng-repeat="imageModel in imageModels" >
                    <div class="listCol col1of2 fleft" >
                        <span class="listCol_Text fleft">{{imageModel.imageModelName}}</span>
                    </div>
                    <div class="listCol col1of4 fright">
                        <div class="CTA_Button Button--Gray fright">Remove Template</div>
                    </div>
                </li>
                <li class="listItem" ng-show="imageModels==null">
                    <div class="listCol col1of2 fleft">
                        <span class="listCol_Text fleft">No Image Templates exist.</span>
                    </div>
                </li>
            </ul>
        </div>
