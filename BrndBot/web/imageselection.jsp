<%-- 
    Document   : imageselection
    Created on : Dec 17, 2015, 11:46:56 AM
...
<body style="background-color:#3D5368">

    <!--Top Nav-->   
    <div class="pop-up-background">
             <div class="pop-up-exit-container">
                <a>
                <div class="pop-up-exit-icon">
            ...
            <div class="pop-up-inner-imageSelection">
                <div class="col-8of10  center">
                    <div class="col-4of10 pushright fleft">
                        <div class="image-selection-button">Upload an Image or from gallery</div>
                    </div>
                    <div class="col-4of10 fright">
                        <div class="image-selection-button">Image Editor</div>
                    </div>
                </div>
            </div>
    ...
    <div class="pop-up-cta-container pop-up-cta-container-imageSelection">
        <a href="/Newest_Files/SocialEditor.html">
