    ...
    <body class="container" >
        ...
        <div id="signupdiv">
            ...
            <img id="logo" src="images/logo.png" class="img-responsive" width="100" height="150"> <br>
                <form class="form-horizontal" id="signform" ng-controller="ForgotPassController" ng-submit="createUser()" >
                     <div class="group">
                        ...
                        <div class="group">
                             <div class="col-md-3 col-md-offset-5">                            
                                 <input id="inputemail" class="form-control simplebox" type="email" required ng-model="user.emailid" ng-hide="true" ng-value="Test" >
                        ...
                        <div  class="form-group">
                               <div class="col-md-5 col-md-offset-5">
                                   <button type="submit"  class="btn btn-info">Change Password</button><br><br><br>
                               </div>
                        </div>
