...
<!--                                                            <img id="{{blocks.block_id}}" class="img-responsive blockchooser" ng-init="showImageOfBlock(blocks.block_id, blocks.mindbody_query)" src=""  width="275" />
                                                            ...
                                                            <div></div><p>&nbsp;</p>
-->
                                                            <label id="{{blocks.block_id}}" class="blockchooser ptr" ng-init="showImageOfBlock(blocks.block_id, blocks.mindbody_query)"  style="font-weight: normal;font-size:16px;margin-left: 10px;">{{blocks.block_name}}</label>
<!--                                                            <div></div><p>&nbsp;</p>-->
